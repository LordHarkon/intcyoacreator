<template>
  <v-dialog v-model="dialog" max-width="1200px" @click:outside="cleanCurrentComponent">
    <v-card>
      <v-card-title class="headline">Choice Images</v-card-title>
          ...
          <v-row>
            <v-col>
              ...
              <v-text-field
                ...
                >px</v-text-field
              >
              <v-col class="pt-2 pb-0">Size and Margin of the choice image</v-col>
              <v-text-field
            ...
            <v-col>
              ...
              <v-color-picker class="mx-auto" v-model="styling.objectImgBorderColor"></v-color-picker>
            </v-col>
          </v-row>
