      ...
      <v-container>
        ...
        <v-row v-if="styling.rowDesignIsAdvanced">
          ...
          <v-col>
            ...
            <v-color-picker class="mx-auto" canvas-height="70" v-model="styling.rowBorderColor"></v-color-picker>

            <v-col class="pb-0 colorPickerText">Color of the choice shadow</v-col>
            <v-color-picker class="mx-auto" canvas-height="70" v-model="styling.rowDropShadowColor"></v-color-picker>
          </v-col>
        </v-row>
