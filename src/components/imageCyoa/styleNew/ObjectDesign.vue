      ...
      <v-container>
          ...
          <v-row>
            ...
            <v-col>
              ...
              <v-text-field
                ...
                >px</v-text-field
              >
              <v-text-field v-model="styling.objectDropShadowV" type="number" suffix="px" label="Vertical Shadow" filled
                >px</v-text-field
              >
              <v-text-field v-model="styling.objectDropShadowBlur" type="number" suffix="px" label="Shadow Blur" filled
                >px</v-text-field
              >
              <v-text-field
        ...
        <v-row>
          <v-col>
            ...
            <v-color-picker class="mx-auto" canvas-height="50" v-model="styling.objectDropShadowColor"></v-color-picker>
          </v-col>
          <v-col>
          ...
          <v-col>
            ...
            <v-color-picker class="mx-auto" canvas-height="50" v-model="styling.objectBorderColor"></v-color-picker>
          </v-col>
        </v-row>
      </v-container>
    </v-card-text>
